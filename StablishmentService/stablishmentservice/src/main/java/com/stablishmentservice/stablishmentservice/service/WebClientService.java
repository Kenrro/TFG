...
public class WebClientService {
    ...
    public <T> T secureGetMethod(String uri, Class<T> responseType, Object... uriVariables) {
        try {
            ...
            throw new GeneralException(
                StablishmentError.SERVICE_COMMUNICATION_FAILED, ex);
        } catch (Exception ex) {
            throw new GeneralException(
                StablishmentError.UNEXPECTED_ERROR, ex
            );
        }
    }
    ...
    public <T> T secureDeleteMethod(String uri, Class<T> responseType, Object... uriVariables) {
        try {
            ...
            throw new GeneralException(StablishmentError.UNEXPECTED_ERROR, ex);
        }
    }
}